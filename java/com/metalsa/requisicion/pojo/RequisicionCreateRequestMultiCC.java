 ...
 * @author APOMS7376
 */
public class RequisicionCreateRequestMultiCC implements Serializable {
    ...
    public RequisicionCreateRequestMultiCC() {
    }

    public RequisicionCreateRequestMultiCC(Integer idCarroCompraDetalle,
    ...
    public RequisicionCreateRequestMultiCC(BigDecimal idCarroCompraDetalle, BigInteger idProyecto, BigInteger idCentroCosto, BigInteger idCarroCompra) {
