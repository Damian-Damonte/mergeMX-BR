...
public class Constants {
    ...
    public static final String URI_API_SEARCH_ENGINE = "/api/v1/search_engine";
    public static final String URI_API_CART = "/api/v1/cart";
    public static final String URI_API_SET_UP_PURCHASE_ORDERS = "/api/v1/set-up-purchase-orders";
    ...
    public final static String URL_IMAGES_FTP = "https://cloud.metalsa.com/appsmet/portallib/dcompras/resources/compras/prod/";
    public final static String URL_IMAGES_FTP_NOT_FOUND = URL_IMAGES_FTP + "resources/imgs/no_image.jpg";
