...
//            log.debug("Error al imprimir log de aprobacion");
    ...
    //<RELEASE_BRASIL>
    @ResponseBody
    @RequestMapping(value = "/actualizarPreaprobacionCC", method = RequestMethod.POST)
    @Transactional
    public Integer actualizarPreaprobacionCC(@RequestBody PreaprobacionCC requisicion) {
        Integer estatus = this.reqPorAprobarRepository.actualizarPreaprobacionCC(requisicion);
