...
public class UsuarioPojo implements Serializable {
    ...
    private List<CcUsuarioPojo> ccUsuarioPojoList;
    ...
    public void setValuesFromEntity(Usuario entity) {
        setValues(
                BigInteger.valueOf(entity.getBusinessGroupId()),
                entity.getIntentosFallidos().shortValue(),
                entity.getDatosDeAuditoria(),
                entity.getEmail(),
                entity.getEstatus(),
                entity.getFechaExpiraPassword(),
                entity.getFechaExpiracionCuenta(),
                entity.getIdEmpleado(),
                entity.getId(),
                entity.getIdiomaEntity().getCodApli(),
                entity.getNombreUsuario(),
                BigInteger.valueOf(Long.parseLong(entity.getOwner())),
                entity.getPassword(),
                entity.getPerfilDeBusqueda(),
                entity.getUltimaEntrada()
        );
    }
    ...
    /**
     * @return the ccUsuarioPojoList
     */
    public List<CcUsuarioPojo> getCcUsuarioPojoList() {
        return ccUsuarioPojoList;
    }

    /**
     * @param ccUsuarioPojoList the ccUsuarioPojoList to set
     */
    public void setCcUsuarioPojoList(List<CcUsuarioPojo> ccUsuarioPojoList) {
        this.ccUsuarioPojoList = ccUsuarioPojoList;
    }
