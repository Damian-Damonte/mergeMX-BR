 ...
 */
@Embeddable
public class UenPorUsuarioPK implements Serializable {
    ...
    public UenPorUsuarioPK() {
    }

    public UenPorUsuarioPK(int idUen, String idUsuario) {
        this.idUen = idUen;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof UenPorUsuarioPK)) {
            return false;
        }
        UenPorUsuarioPK other = (UenPorUsuarioPK) object;
