...
public class NvcVItemsAll implements Serializable {
    ...
    @EmbeddedId
    private NvcVItemsAllPK nvcVItemsAllPK;
    ...
    public int hashCode() {
        int hash = 0;
        hash += (getNvcVItemsAllPK().getIdItem() != null ? getNvcVItemsAllPK().getIdItem().hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.nvcVItemsAllPK.getIdItem() == null && other.nvcVItemsAllPK.getIdItem() != null)
                || (this.nvcVItemsAllPK.getIdItem() != null
                && !this.nvcVItemsAllPK.getIdItem().equals(other.nvcVItemsAllPK.getIdItem()))) {
            return false;
        }
        return true;
    }
...
//    }
    ...
    public NvcVItemsAllPK getNvcVItemsAllPK() {
        return nvcVItemsAllPK;
    }

    public void setNvcVItemsAllPK(NvcVItemsAllPK nvcVItemsAllPK) {
        this.nvcVItemsAllPK = nvcVItemsAllPK;
    }
...
/*
    public SubinventoriesPojo getSubinventarios() {
        return subinventarios;
    }

    public void setSubinventarios(SubinventoriesPojo subinventarios) {
